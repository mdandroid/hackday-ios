...
@interface parcelLockerViewController ()

@end

@implementation parcelLockerViewController{
...
- (void)viewDidLoad {
    ...
    NSString  *imageName = isIphone6 ? @"6PLUSselect-parcel-locker-screen" : @"select-parcel-locker";
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self setTitle : @"Select a Parcel Locker"];
